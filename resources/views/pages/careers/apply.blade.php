...
<div class="full-form">
    ...
    <form  action="{{route('career.apply')}}" class="col-md-6" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-4 form-group mb-3">
            <span class="label-job m-3 pe-3">Your Phone*</span>
        ...
        <div class="col-md-4 form-group mb-3">
            <span class="label-job m-3 pe-3">University*</span>
        ...
        <div class="col-md-4 form-group mb-3">
            <h2 class="label-job ms-3 mb-3 pe-3"> My Experience</h2>

            <span class="label-job m-3 pe-3">Total Years of Experience*</span>
        ...
        <div class="col-md-4 form-group mb-3"> 
          <span class="label-job m-3 pe-3">Notice Period*</span>
        ...
        <div class="col-md-4 form-group mb-3">
            <span class="label-job m-3 pe-3">Current Salary*</span>
        ...
        <div class="col-md-4 form-group mb-3">
            <span class="label-job m-3 pe-3">Expected Salary*</span>
        ...
        <div class="col-md-4 form-group mb-3">
            <span class="label-job m-3 pe-3">Cover Letter*</span>
        ...
        <div class="col-md-4 form-group mb-3">
            ...
            <span class="label-job m-3 pe-3">Resume*</span>

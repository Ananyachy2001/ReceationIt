...
<main>
  <div id="cont" class="">
      <div class="row  row-cols-1  g-3 m-5">
         ...
         <div class="col-12 col-md-12  col-xl-8 p-0 m-0">
                 <form action="{{route('home')}}" class=" border pt-4 pb-4 mt-4  rounded text-center" method="post">
                     ...
                     <div class=" form-group d-flex">
                         <input class=" form-input   " type="text" name="name" value="{{old('name')}}" placeholder="Name" class="form-control">
                         @error('name')
                             <span class="text-danger">{{$message}}</span>
                         @enderror
                         <input class=" form-input  " type="text" name="email" value="{{old('email')}}" placeholder="Email" class="form-control">
                         @error('email')
                             <span class="text-danger">{{$message}}</span>
                         @enderror
                     </div>
                     <div class=" form-group d-flex">
                         <input  class=" form-input   " type="text" name="phone" value="{{old('phone')}}" placeholder="Phone" class="form-control">
                         @error('phone')
                             <span class="text-danger">{{$message}}</span>
                         @enderror

                         <input  class=" form-input  " type="text" name="subject" value="{{old('subject')}}" placeholder="Subject" class="form-control">
                         @error('subject')
                             <span class="text-danger">{{$message}}</span>
                         @enderror
                     </div>
                     ...
                     <div class="">                   
                         <textarea class=" form-input  msg-box" placeholder="Type Message" name="message" value="{{old('message')}}"  class="form-control"></textarea>
                         @error('message')
                             <span class="text-danger">{{$message}}</span>
                         @enderror
                     </div>
